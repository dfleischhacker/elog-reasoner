...
public class Application {
	...
	public static void main(String[] args) throws Exception {
		...
		if((args.length==0) || (!args[0].equals("-r") && !args[0].equals("-rp") && !args[0].equals("-si") && !args[0].equals("-sm") && !args[0].equals("-g"))) {
			...
			System.out.println("-sm for the Pellet-based sampling algorithm (for all of OWL 2)");
